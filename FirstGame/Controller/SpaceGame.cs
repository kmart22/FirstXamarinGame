...
namespace FirstGame.Controller
{
	...
	public class SpaceGame : Game
	{
			...
			protected override void Draw(GameTime gameTime)
			{
				...
				if (this.weapon == 1)
				{
					spriteBatch.DrawString(font, "weapon: laser", new Vector2(GraphicsDevice.Viewport.TitleSafeArea.X, GraphicsDevice.Viewport.TitleSafeArea.Y + 60), Color.White);
				}
				else
				{
					spriteBatch.DrawString(font, "weapon: bird", new Vector2(GraphicsDevice.Viewport.TitleSafeArea.X, GraphicsDevice.Viewport.TitleSafeArea.Y + 60), Color.White);
				}
